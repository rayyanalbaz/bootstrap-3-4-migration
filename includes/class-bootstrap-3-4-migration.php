...
class Bootstrap_3_4_Migration {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Bootstrap_3_4_Migration_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'bootstrap-3-4-migration';
	 ...
	 *
	 * - Bootstrap_3_4_Migration_Loader. Orchestrates the hooks of the plugin.
	 * - Bootstrap_3_4_Migration_i18n. Defines internationalization functionality.
	 * - Bootstrap_3_4_Migration_Admin. Defines all hooks for the admin area.
	 * - Bootstrap_3_4_Migration_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Bootstrap_3_4_Migration_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
